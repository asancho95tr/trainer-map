//Entrenadores
export const ANDRES = { name: 'Andrés', image: 'assets/trainers/Andrés.png' };
...
export const NOAH = { name: 'Noah', image: 'assets/trainers/Noah.png' };
export const SORAYA = { name: 'Soraya', image: 'assets/trainers/Soraya.png' };
export const IRINA_Y_DAVID = {
  name: 'Irina y David',
...
export const BADGE_1 = {
  name: 'Roca',
  image: 'assets/gym-badges/boulder.png',
};
export const BADGE_2 = {
  name: 'Cascada',
  image: 'assets/gym-badges/cascade.png',
};
...
export const BADGE_6 = {
  name: 'Pantano',
  image: 'assets/gym-badges/marsh.png',
};
export const BADGE_7 = {
  name: 'Volcán',
  image: 'assets/gym-badges/volcano.png',
};
export const BADGE_8 = {
  name: 'Tierra',
